...
RSpec.describe Invoice, type: :model do
  ...
  describe 'class methods' do
    describe '#incomplete' do
      it '#incomplete' do
        ...
        item_11 = walmart.items.create!(name: "motor oil", description: "5w30", unit_price: 400)
    ...
    describe '#sorted_by_newest' do
      it 'sorts invoices by created_at with newest first' do
        walmart = Merchant.create!(name: "Wal-Mart")
        bob = Customer.create!(first_name: "Bob", last_name: "Benson")
        item_1 = walmart.items.create!(name: "pickle", description: "sour cucumber", unit_price: 300)
        item_2 = walmart.items.create!(name: "eraser", description: "rubber bit", unit_price: 200)
  ...
  describe 'instance methods' do
    describe '.customer_full_name' do
      it 'returns the full name of the customer as a string with a space between first and last name' do
        bob = Customer.create!(first_name: "Bob", last_name: "Benson")
        mike = Customer.create!(first_name: "Mike", last_name: "Eruzione")
        invoice_1 = bob.invoices.create!(status: 1, created_at: '05 Apr 2022 00:53:36 UTC +00:00')
        invoice_2 = mike.invoices.create!(status: 1, created_at: '04 Apr 2022 00:53:36 UTC +00:00')

        expect(invoice_1.customer_full_name).to eq("Bob Benson")
        expect(invoice_2.customer_full_name).to eq("Mike Eruzione")
      end
    end
