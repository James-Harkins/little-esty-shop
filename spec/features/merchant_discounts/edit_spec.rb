RSpec.describe 'merchant_bulk_discounts edit page' do
  describe 'as a user' do
    describe 'when i visit my bulk_discounts edit page' do
      it 'i see a form to edit the bulk_discount with its attributes pre-populated' do
      ...
      it 'when i change all of the info and click submit, i am redirected
          back to the bulk_discounts show page and i see that the info has been updated' do
        merchant_1 = Merchant.create!(name: "Jim's Plates")
        bulk_discount_1 = merchant_1.bulk_discounts.create!(percentage: 20, quantity_threshold: 10)
        bulk_discount_2 = merchant_1.bulk_discounts.create!(percentage: 30, quantity_threshold: 15)
        bulk_discount_3 = merchant_1.bulk_discounts.create!(percentage: 50, quantity_threshold: 35)
